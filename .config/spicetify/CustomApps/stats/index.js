var stats = (() => {
      ...
      (function () {
        ...
        var runInContext = function runInContext2(context) {
          ...
          var Buffer2 = moduleExports ? context.Buffer : undefined2,
            ...
            spreadableSymbol = Symbol ? Symbol.isConcatSpreadable : undefined2,
            symIterator = Symbol ? Symbol.iterator : undefined2,
            symToStringTag = Symbol ? Symbol.toStringTag : undefined2;
          ...
          var symbolProto = Symbol ? Symbol.prototype : undefined2,
          ...
          function baseMap(collection, iteratee2) {
            var index = -1,
              result2 = isArrayLike(collection)
          ...
          function overRest(func, start, transform2) {
            start = nativeMax(
              start === undefined2 ? func.length - 1 : start,
              0,
            );
            return function () {
              var args = arguments,
  ...
  var OptionsMenuItemIcon = /* @__PURE__ */ import_react.default.createElement(
    "svg",
    {
      width: 16,
      height: 16,
  ...
  var OptionsMenu = import_react.default.memo((props) => {
    ...
    const menu = /* @__PURE__ */ import_react.default.createElement(
      ...
      props.options.map((option) =>
        /* @__PURE__ */ import_react.default.createElement(OptionsMenuItem, {
          value: option.link,
  ...
  var navBar_module_default = {
    topBarHeaderItem: "navBar-module__topBarHeaderItem___piw4C_stats",
    topBarHeaderItemLink: "navBar-module__topBarHeaderItemLink___xA4uv_stats",
    topBarActive: "navBar-module__topBarActive___XhWpm_stats",
    topBarNav: "navBar-module__topBarNav___qWGeZ_stats",
  ...
  var NavbarContent = (props) => {
    ...
    return /* @__PURE__ */ import_react2.default.createElement(
      NavbarContext,
      null,
      /* @__PURE__ */ import_react2.default.createElement(Navbar, {
        ...props,
        windowSize,
      }),
    );
  ...
  var Navbar = (props) => {
    ...
    const [outOfRangeItemIndexes, setOutOfRangeItemIndexes] = (0,
    import_react2.useState)([]);
    let items = props.links.map(
      (link) => new NavbarItem2(link, link === props.activeLink),
    );
    (0, import_react2.useEffect)(() => {
    ...
    return /* @__PURE__ */ import_react2.default.createElement(
      ...
      /* @__PURE__ */ import_react2.default.createElement(
        ...
        items
          .filter((_3, id) => !outOfRangeItemIndexes.includes(id))
          .map((item) =>
            /* @__PURE__ */ import_react2.default.createElement(
              NavbarItemComponent,
              {
        ...
        outOfRangeItemIndexes.length
          ? /* @__PURE__ */ import_react2.default.createElement(NavbarMore, {
  ...
  var useNavigationBar = (links) => {
    ...
    const navbar = /* @__PURE__ */ import_react3.default.createElement(
      navBar_default,
      {
        links,
        activeLink,
    ...
    return /* @__PURE__ */ import_react4.default.createElement(
      ReactComponent.MenuItem,
      {
        ...
        trailingIcon: isActive
          ? /* @__PURE__ */ import_react4.default.createElement(CheckIcon, null)
          : void 0,
  ...
  var DropdownMenu = (props) => {
    ...
    return /* @__PURE__ */ import_react4.default.createElement(
      ContextMenu,
      {
        menu: /* @__PURE__ */ import_react4.default.createElement(
          MenuWrapper2,
          null,
        ),
        trigger: "click",
      ...
      /* @__PURE__ */ import_react4.default.createElement(
        ...
        /* @__PURE__ */ import_react4.default.createElement(
          "svg",
          {
            ...
            "aria-hidden": "true",
            className:
              "Svg-img-16 Svg-img-16-icon Svg-img-icon Svg-img-icon-small",
            viewBox: "0 0 16 16",
            "data-encore-id": "icon",
          },
  ...
  var useDropdownMenu = (options, storageVariable) => {
    const initialOptionID =
      storageVariable &&
      Spicetify.LocalStorage.get(`${storageVariable}:active-option`);
    const initialOption =
      initialOptionID && options.find((e) => e.id === initialOptionID);
    const [activeOption, setActiveOption] = (0, import_react5.useState)(
      initialOption || options[0],
    );
    const [availableOptions, setAvailableOptions] = (0, import_react5.useState)(
      options,
    );
    const dropdown = /* @__PURE__ */ import_react5.default.createElement(
      dropdown_default,
      {
      ...
      /* @__PURE__ */ import_react6.default.createElement(
        ...
        /* @__PURE__ */ import_react6.default.createElement(
          ...
          /* @__PURE__ */ import_react6.default.createElement(
            ...
            {
              className:
                "ButtonInner-sc-14ud5tc-0 ButtonInner-small encore-bright-accent-set",
            },
            "Save",
          ),
        ),
  ...
  var CollectionMenu = ({ id }) => {
    ...
    return /* @__PURE__ */ import_react8.default.createElement(
      ...
      /* @__PURE__ */ import_react8.default.createElement(
        MenuItem2,
        {
          leadingIcon: /* @__PURE__ */ import_react8.default.createElement(
            leading_icon_default,
            {
              path: editIconPath,
            },
          ),
  ...
  var FolderMenu = ({ uri }) => {
    ...
    const setImage = () => {
      ...
      Spicetify.PopupModal.display({
        ...
        content: /* @__PURE__ */ import_react9.default.createElement(
          text_input_dialog_default,
          {
            def: image,
            onSave: setNewImage,
    ...
    return /* @__PURE__ */ import_react9.default.createElement(
      ...
      /* @__PURE__ */ import_react9.default.createElement(
        MenuItem2,
        {
          leadingIcon: /* @__PURE__ */ import_react9.default.createElement(
            leading_icon_default,
            {
              path: editIconPath2,
            },
    ...
    const localAlbumProps =
      type === "localalbum"
        ? {
            ...
            onClick: () => {
              History.push({
                pathname: "better-local-files/album",
                state: { uri },
              });
            },
          }
    ...
    return /* @__PURE__ */ import_react13.default.createElement(
      ...
      /* @__PURE__ */ import_react13.default.createElement(
        ...
        /* @__PURE__ */ import_react13.default.createElement(Card, {
          ...
          headerText: header,
          renderCardImage: () =>
            /* @__PURE__ */ import_react13.default.createElement(CardImage, {
              images: [
                {
                  height: 640,
                  url: imageUrl,
  ...
  async function createPlaylistAsync(infoToCreatePlaylist) {
    ...
    try {
      ...
      const playlistUri = await RootlistAPI.createPlaylist(playlistName, {
        before: "start",
      });
      ...
      /* @__PURE__ */ import_react16.default.createElement(
        ...
        /* @__PURE__ */ import_react16.default.createElement(
          ...
          infoToCreatePlaylist
            ? /* @__PURE__ */ import_react16.default.createElement(
                create_playlist_button_default,
                {
                  infoToCreatePlaylist,
                },
              )
  ...
  var getTopTracks2 = (key, user, range) => {
    ...
    return apiFetch("lfmTopTracks", url).then((res) =>
      val2(res?.toptracks?.track),
    );
  };
  var getTopArtists2 = (key, user, range) => {
    ...
    return apiFetch("lfmTopArtists", url).then((res) =>
      val2(res?.topartists?.artist),
    );
  };
  ...
  var batchCacher = (prefix, cb) => {
    return async (ids) => {
      ...
      results.forEach((result, index) =>
        set(`${prefix}-${uncached[index]}`, result),
      );
  ...
  var convertArtist = async (artist) => {
    const spotifyArtist = await cacher(async () => {
      ...
      const spotifyArtists = searchRes.filter(
        (a) =>
          a.name.localeCompare(artist.name, void 0, { sensitivity: "base" }) ===
          0,
      );
  ...
  var convertAlbum = async (album) => {
    const spotifyAlbum = await cacher(async () => {
      ...
      return searchRes.find(
        (a) =>
          a.name.localeCompare(album.name, void 0, { sensitivity: "base" }) ===
          0,
      );
    })({
  ...
  var convertTrack = async (track) => {
    const spotifyTrack = await cacher(async () => {
      ...
      return searchRes.find(
        (t) =>
          t.name.localeCompare(track.name, void 0, { sensitivity: "base" }) ===
          0,
      );
    })({
  ...
  var ArtistsPage = ({ configWrapper }) => {
    const [dropdown, activeOption] = useDropdownMenu_default(
      DropdownOptions(configWrapper),
      "stats:top-artists",
    );
    const { status, error, data, refetch } = useQuery({
      queryKey: ["top-artists", activeOption.id],
      queryFn: cacher(() =>
        getTopArtists3(activeOption.id, configWrapper.config),
      ),
    });
    ...
    const props = {
      ...
      headerEls: [
        ...
        /* @__PURE__ */ import_react21.default.createElement(
          refresh_button_default,
          {
            callback: () =>
              invalidator(["top-artists", activeOption.id], refetch),
          },
        ),
        /* @__PURE__ */ import_react21.default.createElement(
    ...
    const artistCards = topArtists.map((artist, index) =>
      /* @__PURE__ */ import_react21.default.createElement(
        spotify_card_default,
        {
          type: "artist",
          provider: artist.type,
          uri: artist.uri,
          header: artist.name,
          subheader: artist.playcount
      ...
      !minified &&
        /* @__PURE__ */ import_react22.default.createElement(
          ...
          /* @__PURE__ */ import_react22.default.createElement(
            ...
            {
              className:
                "main-trackList-trackListHeaderRow main-trackList-trackListRowGrid",
              role: "row",
              "aria-rowindex": 1,
            },
            /* @__PURE__ */ import_react22.default.createElement(
            ...
            /* @__PURE__ */ import_react22.default.createElement(
              ...
              /* @__PURE__ */ import_react22.default.createElement(
                ...
                /* @__PURE__ */ import_react22.default.createElement(
                  ...
                  {
                    className:
                      "TypeElement-mesto-type standalone-ellipsis-one-line",
                    "data-encore-id": "type",
                  },
                  "Title",
                ),
              ...
              /* @__PURE__ */ import_react22.default.createElement(
                ...
                /* @__PURE__ */ import_react22.default.createElement(
                  "button",
                  {
                    ...
                    "aria-label": "Duration",
                    className:
                      "main-trackList-column main-trackList-durationHeader main-trackList-sortable",
                    tabIndex: -1,
                  },
                  /* @__PURE__ */ import_react22.default.createElement(
                    "svg",
  ...
  var batchRequest = (size, request) => {
    return (ids) => {
      ...
      return Promise.all(
        chunks.map((chunk) => request(chunk).catch(() => [])),
      ).then((res) => res.flat());
    };
  };
  var getMeanAudioFeatures = async (ids) => {
    ...
    const audioFeaturesList = await batchCacher(
      "features",
      batchRequest(100, getAudioFeatures),
    )(ids);
  ...
  var parseAlbums = async (albumsRaw) => {
    ...
    const uris = Object.keys(frequencyMap)
      ...
      .slice(0, 500);
    const albums = (await batchCacher("album", getAlbumMetas)(uris)).filter(
      Boolean,
    );
    const releaseYears = {};
    const uniqueAlbums = albums.map((album) => {
      if (album?.date?.isoString) {
        ...
        releaseYears[year] =
          (releaseYears[year] || 0) + frequencyMap[album.uri];
      }
    ...
    return {
      releaseYears,
      albums: {
        contents: uniqueAlbums,
        length: Object.keys(frequencyMap).length,
      },
    };
  };
  var parseArtists = async (artistsRaw) => {
    ...
    const ids = Object.keys(frequencyMap)
      .sort((a, b) => frequencyMap[b] - frequencyMap[a])
      .slice(0, 250);
    const artists = await batchCacher(
      "artist",
      batchRequest(50, getArtistMetas),
    )(ids);
    const genres = {};
  ...
  var parseLiked = async (tracks) => {
    ...
    return tracks.map((t) => ({
      ...t,
      liked: t.type === "spotify" ? likedMap.get(t.uri) : false,
    }));
  };
      ...
      artists.map((artist, index) => {
        return /* @__PURE__ */ import_react23.default.createElement(
          spotify_card_default,
          {
            ...
            header: artist.name,
            subheader: artist.playcount
              ? `\u29BE ${formatNumber(artist.playcount)} Scrobbles`
              : "Artist",
            imageUrl: artist.image,
            badge: `${index + 1}`,
          },
  ...
  var ChartsPage = ({ configWrapper }) => {
    ...
    const { status, error, data, refetch } = useQuery({
      ...
      queryFn: (props2) =>
        cacher(() => getChart(activeOption.id, configWrapper.config))(
          props2,
        ).then((res) => ("artists" in res[0] ? parseLiked(res) : res)),
    });
    const Status2 = useStatus_default(status, error);
    const props = {
      ...
      headerEls: [
        ...
        /* @__PURE__ */ import_react23.default.createElement(
          ...
          {
            callback: () =>
              invalidator(["top-charts", activeOption.id], refetch),
          },
        ),
        /* @__PURE__ */ import_react23.default.createElement(
          settings_button_default,
    ...
    const chartToRender =
      activeOption.id === "artists"
        ? /* @__PURE__ */ import_react23.default.createElement(ArtistChart, {
            artists: items,
          })
  ...
  var ExplicitBadge = import_react24.default.memo(() => {
    return /* @__PURE__ */ import_react24.default.createElement(
      ...
      /* @__PURE__ */ import_react24.default.createElement(
        ...
        {
          className:
            "TypeElement-ballad-textSubdued-type main-trackList-rowBadges",
          "data-encore-id": "type",
          "aria-label": "Explicit",
          title: "Explicit",
        },
  ...
  var MenuWrapper = import_react24.default.memo((props) =>
    /* @__PURE__ */ import_react24.default.createElement(
  ...
  var TrackRow = (props) => {
    ...
    return /* @__PURE__ */ import_react24.default.createElement(
      ...
      /* @__PURE__ */ import_react24.default.createElement(
        Spicetify.ReactComponent.ContextMenu,
        {
          menu: /* @__PURE__ */ import_react24.default.createElement(
            MenuWrapper,
            {
              uri: props.uri,
            },
          ...
          /* @__PURE__ */ import_react24.default.createElement(
                  ...
                  /* @__PURE__ */ import_react24.default.createElement(
                    ...
                    /* @__PURE__ */ import_react24.default.createElement(
                      "svg",
                      {
                        ...
                        "aria-hidden": "true",
                        className:
                          "Svg-img-24 Svg-img-24-icon main-trackList-rowPlayPauseIcon",
                        viewBox: "0 0 24 24",
                        "data-encore-id": "icon",
                      },
                      /* @__PURE__ */ import_react24.default.createElement(
              ...
              /* @__PURE__ */ import_react24.default.createElement(
                ...
                /* @__PURE__ */ import_react24.default.createElement(
                  "div",
                  {
                    dir: "auto",
                    className:
                      "TypeElement-ballad-textBase TypeElement-ballad-textBase-type main-trackList-rowTitle standalone-ellipsis-one-line",
                    "data-encore-id": "type",
                  },
                  props.name,
                ),
                ...
                /* @__PURE__ */ import_react24.default.createElement(
                  ...
                  {
                    className:
                      "TypeElement-mesto-textSubdued TypeElement-mesto-textSubdued-type main-trackList-rowSubTitle standalone-ellipsis-one-line",
                    "data-encore-id": "type",
                  },
                  ArtistLinks,
                ),
            ...
            /* @__PURE__ */ import_react24.default.createElement(
              ...
              /* @__PURE__ */ import_react24.default.createElement(
                ...
                {
                  className:
                    "TypeElement-mesto-textSubdued TypeElement-mesto-textSubdued-type main-trackList-rowDuration",
                  "data-encore-id": "type",
                },
              ...
              /* @__PURE__ */ import_react24.default.createElement(
                ...
                /* @__PURE__ */ import_react24.default.createElement(
                  "button",
                  {
                    ...
                    className:
                      "main-moreButton-button Button-sm-16-buttonTertiary-iconOnly-condensed-useBrowserDefaultFocusStyle Button-small-small-buttonTertiary-iconOnly-condensed-useBrowserDefaultFocusStyle main-trackList-rowMoreButton",
                    tabIndex: -1,
                  },
                  /* @__PURE__ */ import_react24.default.createElement(
                    Spicetify.ReactComponent.TooltipWrapper,
  ...
  var TracksPage = ({ configWrapper }) => {
    ...
    const { status, error, data, refetch } = useQuery({
      ...
      queryFn: (props2) =>
        cacher(() => getTopTracks3(activeOption.id, configWrapper.config))(
          props2,
        ).then(parseLiked),
    });
    const Status2 = useStatus_default(status, error);
    const props = {
      ...
      headerEls: [
        ...
        /* @__PURE__ */ import_react25.default.createElement(
          ...
          {
            callback: () =>
              invalidator(["top-tracks", activeOption.id], refetch),
          },
        ),
        /* @__PURE__ */ import_react25.default.createElement(
          settings_button_default,
    ...
    const trackRows = topTracks.map((track, index) =>
      /* @__PURE__ */ import_react25.default.createElement(track_row_default, {
        index: index + 1,
        ...track,
  ...
  var getGenres = async (time_range, config) => {
    const topTracks = await cacher(() => getTopTracks3(time_range, config))({
    ...
    const props = {
      ...
      headerEls: [
        ...
        /* @__PURE__ */ import_react29.default.createElement(
          ...
          {
            callback: () =>
              invalidator(["top-genres", activeOption.id], refetch),
          },
        ),
        /* @__PURE__ */ import_react29.default.createElement(
          settings_button_default,
  ...
  function scrollGrid(event) {
    ...
    if (
      grid.scrollWidth - grid.clientWidth - grid.scrollLeft <=
      grid.clientWidth
    ) {
  ...
  var getLibrary = async (type) => {
    ...
    const contents = await Promise.all(
      playlists.map((p) => getFullPlaylist(p.uri)),
    );
  ...
  var AlbumsPage = ({ configWrapper }) => {
    ...
    const { status, error, data, refetch } = useQuery({
      ...
      queryFn: cacher(() =>
        getTopAlbums2(activeOption.id, configWrapper.config),
      ),
    });
    const Status2 = useStatus_default(status, error);
    const props = {
      ...
      headerEls: [
        ...
        /* @__PURE__ */ import_react32.default.createElement(
          ...
          {
            callback: () =>
              invalidator(["top-albums", activeOption.id], refetch),
          },
        ),
        /* @__PURE__ */ import_react32.default.createElement(
          settings_button_default,
  ...
  var checkForUpdates = (setNewUpdate) => {
    fetch("https://api.github.com/repos/harbassan/spicetify-apps/releases")
      ...
      .then(
        (result) => {
          const releases = result.filter((release) =>
            release.name.startsWith("stats"),
          );
  ...
  var App = () => {
    ...
    const pages = {
      ["Artists"]: /* @__PURE__ */ import_react33.default.createElement(
        top_artists_default,
        {
          configWrapper,
        },
      ),
      ["Tracks"]: /* @__PURE__ */ import_react33.default.createElement(
        top_tracks_default,
        {
          configWrapper,
        },
      ),
      ["Albums"]: /* @__PURE__ */ import_react33.default.createElement(
        top_albums_default,
        {
          configWrapper,
        },
      ),
      ["Genres"]: /* @__PURE__ */ import_react33.default.createElement(
        top_genres_default,
        {
          configWrapper,
        },
      ),
      ["Library"]: /* @__PURE__ */ import_react33.default.createElement(
        library_default,
        {
          configWrapper,
        },
      ),
      ["Charts"]: /* @__PURE__ */ import_react33.default.createElement(
        charts_default,
        {
          configWrapper,
        },
    ...
    const tabPages = [
      ...
      "Library",
      "Charts",
    ].filter((page) => configWrapper.config[`show-${page.toLowerCase()}`]);
    const [navBar, activeLink, setActiveLink] =
      useNavigationBar_default(tabPages);
    const [hasPageSwitched, setHasPageSwitched] =
      import_react33.default.useState(false);
    const [newUpdate, setNewUpdate] = import_react33.default.useState(false);
    import_react33.default.useEffect(() => {
      setActiveLink(
        Spicetify.LocalStorage.get("stats:active-link") || "Artists",
      );
